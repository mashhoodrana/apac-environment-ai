            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                  <span className="block xl:inline">APAC AI Solution for</span>{' '}
                  <span className="block text-primary-light xl:inline">Environmental Monitoring</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 dark:text-gray-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Leveraging Google's AI and Earth observation technologies to monitor environmental changes through NDVI, Temperature, and Albedo analysis.
                </p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <Link
                      to="/about"
                      className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-gray-700 bg-gray-100 hover:bg-gray-200 dark:text-white dark:bg-gray-700 dark:hover:bg-gray-600 md:py-4 md:text-lg md:px-10"
                    >
                      About Us
                    </Link>
                  </div>
          ...
          <div className="h-56 w-full sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="p-8 text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Our solution uses satellite imagery and AI to analyze environmental indicators:
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 dark:text-gray-400 lg:mx-auto">
              Our solution provides comprehensive tools for environmental analysis and monitoring.
            </p>
          </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">NDVI Analysis</h3>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Temperature Mapping</h3>
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-white">Albedo Measurement</h3>
                  <p className="mt-2 text-base text-gray-500 dark:text-gray-400">
                    Analyze surface reflectivity to understand energy absorption and climate impacts.
                  </p>
                </div>
              </div>
            </div>
